...
def setup() :
    interface.regist_res("project,system,xmodule,prj_main" , "res.inner")
    ...
    interface.regist_cmd("check,info,conf,reconf,start,stop,restart,data" , "impl.rg_cmd.rg_cmd_prj")
