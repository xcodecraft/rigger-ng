...
# from  pylon.parser import  php_class_parser 
...
class pylon_autoload_tc(base.tc_tools.rigger_tc):
    ...
    def test_pylon_autoload(self) :
        conf = utls.rg_var.value_of("${PRJ_ROOT}/src/extends/res/pylon/pylon_res.yaml")
        mock = base.tc_tools.res_mock()
        # with   mock :
        self.asst_cmd(conf,"conf -s pylon_autoload -e dev  -d1 ")
