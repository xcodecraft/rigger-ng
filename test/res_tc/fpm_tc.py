...
class fpm_tc(base.tc_tools.rigger_tc):
    ...
    def test_config(self) :
        result = self.asst_cmd("start -s fpm -e dev")
        expect = """
        """
        print result
    ...
    def test_stop(self) :
        result = self.asst_cmd("stop -s fpm -e dev")
        expect = """
        """
        print result
    ...
    def test_reload(self) :
        result = self.asst_cmd("reload -s fpm -e dev")
        expect = """
        """
        print result

    def test_restart(self) :
        result = self.asst_cmd("restart -s fpm -e dev")
        expect = """
        """
        print result
